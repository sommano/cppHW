...
//default constructor creates string o 0 bytes
String::String()
{
    value = new char[1];
    value[0] = '\0';
...
//private (helper) constructor, used only bytes 
//class functions for creating a new string offset
...
//operator equals, free existing memory
...
//reference to character so it can bytes
//changed!
